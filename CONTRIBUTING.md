...
documents](https://datatracker.ietf.org/wg/slim/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/slim/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/slim)). This will ensure that
